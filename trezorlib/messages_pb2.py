...
# libprotoc 3.4.0
# trezor-common 6df1c6c2da37724017f324815d5efd78bd2e6bbd
...
_MESSAGETYPE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='MessageType_IotaGetAddress', index=72, number=75,
      options=_descriptor._ParseOptions(descriptor_pb2.EnumValueOptions(), _b('\220\265\030\001')),
      type=None),
    _descriptor.EnumValueDescriptor(
      name='MessageType_IotaAddress', index=73, number=76,
      options=_descriptor._ParseOptions(descriptor_pb2.EnumValueOptions(), _b('\230\265\030\001')),
      type=None),
    _descriptor.EnumValueDescriptor(
      name='MessageType_IotaShowSeed', index=74, number=77,
      options=_descriptor._ParseOptions(descriptor_pb2.EnumValueOptions(), _b('\220\265\030\001')),
      type=None),
    _descriptor.EnumValueDescriptor(
      name='MessageType_IotaTxRequest', index=75, number=78,
      options=_descriptor._ParseOptions(descriptor_pb2.EnumValueOptions(), _b('\220\265\030\001')),
      type=None),
    _descriptor.EnumValueDescriptor(
      name='MessageType_IotaTxApproved', index=76, number=79,
      options=_descriptor._ParseOptions(descriptor_pb2.EnumValueOptions(), _b('\230\265\030\001')),
      type=None),
    _descriptor.EnumValueDescriptor(
      name='MessageType_IotaTxDetails', index=77, number=80,
      options=_descriptor._ParseOptions(descriptor_pb2.EnumValueOptions(), _b('\220\265\030\001')),
      type=None),
    _descriptor.EnumValueDescriptor(
...
MessageType_IotaGetAddress = 75
MessageType_IotaAddress = 76
MessageType_IotaShowSeed = 77
MessageType_IotaTxRequest = 78
MessageType_IotaTxApproved = 79
MessageType_IotaTxDetails = 80
...
_IOTAGETADDRESS = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='seed_index', full_name='IotaGetAddress.seed_index', index=0,
      number=1, type=13, cpp_type=3, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_IOTAADDRESS = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='address', full_name='IotaAddress.address', index=0,
      number=1, type=9, cpp_type=9, label=2,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='seed_index', full_name='IotaAddress.seed_index', index=1,
      number=2, type=13, cpp_type=3, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_IOTATXREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='seed_index', full_name='IotaTxRequest.seed_index', index=3,
      number=4, type=13, cpp_type=3, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='remainder_index', full_name='IotaTxRequest.remainder_index', index=4,
      number=5, type=13, cpp_type=3, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='tag', full_name='IotaTxRequest.tag', index=5,
      number=6, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='timestamp', full_name='IotaTxRequest.timestamp', index=6,
...
_IOTATXDETAILS = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='timestamp', full_name='IotaTxDetails.timestamp', index=0,
